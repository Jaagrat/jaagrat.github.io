...
function myFunction(){
  ...
  document.getElementById('newLine').innerHTML="";
    var dynamicHTML="";
    var arraySize=quotes.length;
    var quoteChosen=Math.floor(Math.random()*arraySize);
    dynamicHTML+= "<br>" + quotes[quoteChosen].quote;
    dynamicHTML+= "<br>By " + quotes[quoteChosen].source;
    dynamicHTML+= "<br>It is a  "+ quotes[quoteChosen].tags +" kind of a quote";
    document.getElementById('newLine').innerHTML=dynamicHTML;
}
